"""
Django settings for spring_band_43337 project.
...
ROOT_URLCONF = 'spring_band_43337.urls'
...
WSGI_APPLICATION = 'spring_band_43337.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_band_43337 API",
    "DESCRIPTION": "API documentation for spring_band_43337 App",
    "VERSION": "v1",
}
